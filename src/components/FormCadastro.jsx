   ...
   <div className={styleFormCadastro.formWrapper}>
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
     <div className={styleFormCadastro.inputContainer}>
      ...
      />
      {errors.nome && (
       <p className={styleFormCadastro.pErro}>Nome é obrigatório</p>
      )}
     </div>
     <div className={styleFormCadastro.inputContainer}>
      <label>Email</label>
      ...
      {errors.sexo && (
       <p className={styleFormCadastro.pErro}>Sexo é obrigatório</p>
      )}
     </div>
     <div className={styleFormCadastro.inputContainer}>
      <label>CPF</label>
      ...
      />
      {errors.cpf && (
       <p className={styleFormCadastro.pErro}>CPF inválido ou já cadastrado</p>
      )}
     </div>
     <div className={styleFormCadastro.inputContainer}>
      ...
      />
      {errors.data_nasc && (
       <p className={styleFormCadastro.pErro}>
     ...
     <div className={styleFormCadastro.inputContainer}>
      ...
      />
      {errors.email && (
       <p className={styleFormCadastro.pErro}>Email inválido</p>
      )}
     </div>
     <div className={styleFormCadastro.inputContainer}>
      <label>Senha</label>
      ...
      />
      {errors.senha && (
       <p className={styleFormCadastro.pErro}>Senha é obrigatória</p>
      )}
     </div>
     <div className={styleFormCadastro.inputContainer}>
      <label>CEP</label>
      <div className={styleFormCadastro.cepContainer}>
       ...
       {errors.CEP && (
        <p className={styleFormCadastro.pErro}>CEP é obrigatório</p>
       )}
      </div>
     </div>
     <div className={styleFormCadastro.inputContainer}>
      ...
      />
      {errors.Logradouro && (
       <p className={styleFormCadastro.pErro}>Logradouro é obrigatório</p>
      )}
     </div>
     <div className={styleFormCadastro.inputContainer}>
     ...
     <div className={styleFormCadastro.inputContainer}>
      ...
      />
      {errors.Bairro && (
       <p className={styleFormCadastro.pErro}>Bairro é obrigatório</p>
      )}
     </div>
     <div className={styleFormCadastro.inputContainer}>
      ...
      />
      {errors.Localidade && (
       <p className={styleFormCadastro.pErro}>Localidade é obrigatória</p>
      )}
     </div>
     <div className={styleFormCadastro.inputContainer}>
      <label>UF</label>
    ...
    <p className={styleFormCadastro.switchButton} onClick={switchToLogin}>
